  ...
  return (
    ...
    <section className="-mt-[100px] md:-mt-[120px] relative overflow-x-clip">
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-4 sm:px-6 pb-32 md:pb-52 md:mt-10">
        <h1 className="text-center font-minion-pro text-[#450000] text-3xl md:text-7xl">
          {t("title")}
        </h1>
            ...
            {sections.map((sec, i) => (
              <li key={i} className="relative">
                <div
                  ...
                  font-minion-pro text-[#450000] font-semibold tracking-wide leading-none
                ...
                <div className="flex items-start gap-2">
                  {sec.intro && (
                    <p className="mt-2 font-poppins text-sm md:text-base leading-7 text-[#450000]/90">
                      {sec.intro}
                    </p>
                  )}

                  {Array.isArray(sec.list) && sec.list.length > 0 && (
                    <ul className="mt-3 list-disc pl-6 font-poppins text-sm md:text-base leading-7 text-[#450000]/90 space-y-1.5">
                  ...
                  {sec.sub && (
                    <p className="mt-3 font-poppins text-sm md:text-base text-[#450000]">
                      <span className="font-semibold">{sec.sub}</span>
                    </p>
                  )}
                  {Array.isArray(sec.list2) && sec.list2.length > 0 && (
                    <ul className="mt-2 list-disc pl-6 font-poppins text-sm md:text-base leading-7 text-[#450000]/90 space-y-1.5">
                  ...
                  {sec.note && (
                    <p className="mt-3 font-poppins text-sm md:text-base text-[#450000]/80">
                      {sec.note}
                    </p>
                  )}
                </div>
